...
auto main() -> int32_t
{
    ...
    base_shader_vertex.source(core::as_bytes(core::File::read("shaders/base_shader.vert", std::ios::binary)));

    opengl::ShaderStage base_shader_fragment { opengl::constants::fragment_shader };
    base_shader_fragment.create();
    base_shader_fragment.source(core::as_bytes(core::File::read("shaders/base_shader.frag", std::ios::binary)));

    opengl::ShaderStage sprite_shader_vertex { opengl::constants::vertex_shader };
    sprite_shader_vertex.create();
    sprite_shader_vertex.source(core::as_bytes(core::File::read("shaders/base_sprite_shader.vert", std::ios::binary)));

    opengl::ShaderStage sprite_shader_fragment { opengl::constants::fragment_shader };
    sprite_shader_fragment.create();
    sprite_shader_fragment.source(core::as_bytes(core::File::read("shaders/base_sprite_shader.frag", std::ios::binary)));

    opengl::ShaderStage model_shader_vertex { opengl::constants::vertex_shader };
    model_shader_vertex.create();
    model_shader_vertex.source(core::as_bytes(core::File::read("shaders/base_model_shader.vert", std::ios::binary)));

    opengl::ShaderStage model_shader_fragment { opengl::constants::fragment_shader };
    model_shader_fragment.create();
    model_shader_fragment.source(core::as_bytes(core::File::read("shaders/base_model_shader.frag", std::ios::binary)));
    ...
    base_texture.upload (base_image.width, base_image.height, opengl::constants::rgb,  0, core::as_bytes(base_image.pixels));
